...
function cargarVehiculos(){
    ...
    if (!isset($result)) {
        ...
        foreach ($result as $f) {
            ...
            <tr>
                <td><img src="../'.$f['foto'].'" alt="Foto" style="width: 80px; height: 80px"></td>
                <td><img src="../'.$f['foto1'].'" alt="Foto1" style="width: 80px; height: 80px"></td>
                <td><img src="../'.$f['foto2'].'" alt="Foto2" style="width: 80px; height: 80px"></td>
                <td><img src="../'.$f['foto3'].'" alt="Foto3" style="width: 80px; height: 80px"></td>
                <td>'. $f['placa'] .'</td>
                <td>'. $f['marca'].' </td>
                <td>'. $f['referencia'] .'</td>
                <td>'. $f['modelo'].' </td>
