...
function cargarPublicacionesRes(){
    ...
    if (!isset($result)) {
        ...
        $count = count($result);
        $start = max(0, $count - 3); // Calcula el índice de inicio para los últimos 3 registros
        ...
        foreach (array_slice($result, $start, 3) as $f) {
            ...
            <a href="ver-publicaciones.php"> <img id="diagonal-arrow" width="20" height="20" src="./icons/arrow.png"> </a>  
            </div> 
            </header>
